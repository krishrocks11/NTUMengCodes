...
ValtrainAcc_acc_temp_inner4fold = zeros(1,4);
ValtestAcc_acc_temp_inner4fold = zeros(1,4);
                ...
                for type = 1:numel(tune.normal_type)
                    ...
                    for i = 1:num_CV
                        ...
                        [~,ValtrainAcc_acc_temp_inner4fold(:,i),ValtestAcc_acc_temp_inner4fold(:,i)]  = ... 
                            RVFL(trainX_val,trainY_val,testX_val,testY_val,option);

                    end

                    train_acc_temp = mean(ValtrainAcc_acc_temp_inner4fold);
                    test_acc_temp = mean(ValtestAcc_acc_temp_inner4fold);
         
                    if test_acc_temp>MAX_acc
                        validation_trainAcc(i) = train_acc_temp;
                        validation_testAcc(i) = test_acc_temp;
...
ValtrainAcc_acc_temp_inner4fold_second = zeros(1,4);
ValtestAcc_acc_temp_inner4fold_second = zeros(1,4);
        ...
        for j = 1:numel(C_range_new)
            ...
            for i = 1:num_CV
                ...
                [~,ValtrainAcc_acc_temp_inner4fold_second(:,i),ValtestAcc_acc_temp_inner4fold_second(:,i)]  = ... 
                    RVFL(trainX_val,trainY_val,testX_val,testY_val,option_temp);

            end

            train_acc_temp = mean(ValtrainAcc_acc_temp_inner4fold_second);
            test_acc_temp = mean(ValtestAcc_acc_temp_inner4fold_second);
...
[~,trainAcc_temp,testAcc_temp]  = RVFL(trainX,trainY,testX,testY,option_best);
trainAcc = trainAcc_temp;
testAcc = testAcc_temp;
