function [majvotacc,TestingAccuracy,Testing_time,ProbScores] = OL_MRVFLpredict(testX,testY,model,option,num_classes)
...
majvotacc = majorityVoting_v2(testY,ProbScores,i,Nsample,num_classes);
